...
def get_adjusted_area_and_margin_of_error(data, df_err_adjust, array_count, confidence_interval=1.96):
    ...
    stand_error_area = stand_error_area_proportion * np.nansum(array_count) * 900 / 1000000 * 1.96
    print(f'standard error of area estimation at 95% confidence level {np.round(stand_error_area, 2)}')
